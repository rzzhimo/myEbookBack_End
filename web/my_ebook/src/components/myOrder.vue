            ...
            <el-main>
                ...
                <el-card class="box-card">
                    <div slot="header" class="clearfix">
                        ...
                        <el-col :span="4"><span>我的订单</span></el-col>
                        <el-col :span="4"><span>作者</span></el-col>
                        <el-col :span="4"><span>语言</span></el-col>
                        <el-col :span="4"><span>售价</span></el-col>
                    ...
                    <div v-for="o in 2" :key="o" class="text item">
                        ...
                        <el-col :span="4">
                            ...
                            <el-row>{{ tableData[o].bookName+" " }}</el-row>
                            <!--<el-row><img :src="tableData[o].images" alt=""></el-row>-->
                        </el-col>
                        <!--<el-col :span="4"><img :src="tableData[o].images" alt=""></el-col>-->
                        <el-col :span="4">{{ tableData[o].author+" " }}</el-col>
                        <el-col :span="4">{{ tableData[o].language+" " }}</el-col>
                        <el-col :span="4">{{ tableData[o].sales*tableData[o].num+" " }}</el-col>



                        <el-button-group>
                            <el-button type="danger"
                                       position="relative" icon="el-icon-delete"></el-button>
                            <el-button type="primary"
                                       position="relative" >再次购买</el-button>
                        </el-button-group>
                        <br/>
                            </el-col>
                        </el-row>
        ...
        data () {
            return {
                ...
                tableData: [{
                    ...
                    num: 1,
                    sales: 38.00,
                    images:require("../assets/shijian.jpg")
                    ...
                    num:1,
                    sales: 44.00,
                    images:require("../assets/hong.jpg")
